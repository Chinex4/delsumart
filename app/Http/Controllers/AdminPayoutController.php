...
class AdminPayoutController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.payouts', [
            ...
            'stats' => [
                ...
                'processing' => PayoutRequest::where(
                    'status',
                    'processing',
                )->count(),
                'paid_amount' => PayoutRequest::where('status', 'paid')->sum(
                    'amount',
                ),
            ],
        ]);
    ...
    public function update(Request $request, PayoutRequest $payout)
    {
        ...
        abort_unless(
            in_array($payout->status, ['pending', 'processing'], true),
            409,
            'This payout is already final.',
        );
        ...
        DB::transaction(function () use ($request, $payout, $data) {
            ...
            AuditLog::create([
                ...
                'action_type' => 'payout_'.$data['status'],
