...
class SecurityAndMarketplaceTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_verified_student_can_create_listing(): void
    {
        $u = $this->student(true);
    ...
    {
        $this->actingAs($this->student(true))->get('/admin')->assertForbidden();
    }
}
